  ...
  fnc: function fnc(response) {
    ...
    if (response.offer != "") {
      ...
      if (today < offerDate) {
        ...
        disccount = "<div class=\"ps-product__badge\">-".concat(value, "%</div>");
        price = "<p class=\"ps-product__price sale\">$<span class=\"end-price\">".concat(offer, "</span> <del>$").concat(response.price, " </del></p>");
      } else {
        price = "<p class=\"ps-product__price\">$<span class=\"end-price\">".concat(response.price, "</span></p>");
      }
    } else {
      price = "<p class=\"ps-product__price\">$<span class=\"end-price\">".concat(response.price, "</span></p>");
    }
...
exports.DinamicPrice = DinamicPrice;
var DinamicReviews = {
  fnc: function fnc(response) {
    /*=============================================
...
exports.DinamicReviews = DinamicReviews;
var DinamicRating = {
  fnc: function fnc(response) {
    /*=============================================
